...
import bookThemes from "@/data/book_themes.json"
import defaultBooks from "@/data/books.json"
import { BookstorePage } from "@/components/component/bookstore-page";
...
export default function Home() {
  ...
  const RenderLoading = () => {
    return (
      <div className="flex flex-col min-h-[100dvh] items-center justify-center">
        ...
        <span class="sr-only">Chargements...</span>
      </div>
  ...
  return (
    <BookstorePage church={church} books={books} themes={themes} />
  );
}
