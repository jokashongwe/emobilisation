...
import DefContents from "@/data/contents.json"
...
export default function AdminHome() {
    ...
    return (
        <AdminLayout active={"cms"} church={church}>

            <Card className="p-3" >
                <CardContent className="flex flex-col gap-2 py-4 px-1">
                    <CardTitle className="text-xl"> Gestion du contenu </CardTitle>
                </CardContent>
                <div
                        ...
                        <TableBody className="divide-y">
                            {contents && contents.map(content => (
                                <TableRow className="hover:bg-gray-100 dark:hover:bg-gray-900">
                                    ...
                                    <TableCell>
                                        <Link href={"/admin/cms/" + content.contentId} >
